...
css = re.sub(r'rgba\(\s*255\s*,\s*255\s*,\s*255\s*,\s*0\.03\s*\)', 'var(--overlay-light)', css)
css = re.sub(r'rgba\(\s*255\s*,\s*255\s*,\s*255\s*,\s*0\.05\s*\)', 'var(--overlay-medium)', css)
css = re.sub(r'rgba\(\s*255\s*,\s*255\s*,\s*255\s*,\s*0\.1\s*\)', 'var(--overlay-strong)', css)
css = re.sub(r'rgba\(\s*255\s*,\s*255\s*,\s*255\s*,\s*0\.15\s*\)', 'var(--overlay-extra)', css)
css = re.sub(r'rgba\(\s*26\s*,\s*26\s*,\s*31\s*,\s*0\.6\s*\)', 'var(--input-bg)', css)
css = re.sub(r'rgba\(\s*11\s*,\s*11\s*,\s*13\s*,\s*0\.85\s*\)', 'var(--nav-bg)', css)
css = css.replace("rgba(26, 26, 31, 1)", "var(--card-bg)")
...
print("Successfully updated theme files.")
